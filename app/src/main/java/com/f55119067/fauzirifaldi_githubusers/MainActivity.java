package com.f55119067.fauzirifaldi_githubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("List of GitHub Users | F55119067");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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 ");
